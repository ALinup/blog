...
//EDITOR STYLE
function stylish_news_block_styles() {

	wp_enqueue_style( 'stylish-news-editor-google-font', 'https://fonts.googleapis.com/css?family=Noto+Sans');

	wp_enqueue_style( 'stylish-news-editor-styles', get_template_directory_uri() . '/editor-style.css' );

}

add_action( 'enqueue_block_editor_assets', 'stylish_news_block_styles' );
