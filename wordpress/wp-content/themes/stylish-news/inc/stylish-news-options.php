...
function stylish_news_theme_info_display() {
	...
	<div class="wrap stylish-news-adm">
		<h1 class="header-welcome"><?php esc_html_e('Welcome to Stylish News - 0.0.06', 'stylish-news'); ?></h1>
		<div class="stylish-news-adm-dsply-fl stylish-news-adm-fl-wrap stylish-news-adm-jc-sp-btw">
			...
			<div class="stylish-news-adm-wid-49 theme-para theme-doc stylish-news-adm-mobwid-100">
				...
				<p>
					<a href="<?php echo esc_url('https://zidithemes.tumblr.com/post/613567187127599104/stylish-news'); ?>" class="button button-secondary" target="_blank">
			...
			<div class="stylish-news-adm-wid-49 theme-para theme-opt stylish-news-adm-mobwid-100">
				...
				<p>
					<a href="<?php echo esc_url('https://zidithemes.tumblr.com/post/616835522660286464/stylish-news-pro'); ?>" class="button button-primary" target="_blank">
				...
				<table class="stylish-news-adm-wid-100">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a class="pro-link-btn" href="<?php echo esc_url('https://zidithemes.tumblr.com/post/616835522660286464/stylish-news-pro'); ?>" target="_blank">
						...
						<tr>
							...
							<td class="go-pro">
								<span class="">
									<a class="link" href="<?php echo esc_url('https://zidithemes.tumblr.com/post/616835522660286464/stylish-news-pro'); ?>" target="_blank">
